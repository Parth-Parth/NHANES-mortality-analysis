...
setwd("/home/bisag/Documents/health_data_analysis/")
...
# srvyout <- "NHANES" # shorthand dataset name here

# # Example syntax:
# #srvyin <- paste("NHIS_1986_MORT_2015_PUBLIC.dat")   
# #srvyout <- "NHIS_1986"      
...
srvyin <- paste("data/2013-2014/NHANES_2013_2014_MORT_2015_PUBLIC.dat")   # full .DAT name here
srvyout <- "NHANES" # shorthand dataset name here
...
assign(paste0(srvyout), dsn)
print(dsn)
write.csv(dsn,"data/2013-2014/mort.csv", row.names = FALSE)
rm(dsn, srvyin, srvyout)